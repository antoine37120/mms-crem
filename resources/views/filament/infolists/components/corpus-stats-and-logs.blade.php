            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-primary-50 dark:bg-primary-900/20 p-4 rounded-lg  text-center">
                        <div class="text-2xl font-semibold text-primary-700 dark:text-primary-300">{{ $state['collections_count'] }}</div>
                        <div class="text-sm font-medium text-primary-900 dark:text-primary-100">Collections</div>
                    </div>
